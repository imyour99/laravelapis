...
@section('data-content')
            ...
            <div class="row">
                <div class="col-lg-1 col-sm-1" style="max-width:95px;padding-right: 0 !important;">
                    ...
                    @if (Auth::user()->profile_img == '')
                        <img alt="avatar" class="rounded" src="{{ asset('public/assets/img/users/user.png')}}">
                    @else
                        <img alt="avatar" class="rounded" src="{{ asset('public/uploads/profile_images/'.Auth::user()->profile_img)}}">
                    @endif
                </div>
                <div class="col-lg-7 col-sm-7 ml-2">
                    ...
                    <span class="text-dark-black ml-3">{{ Auth::user()->email }}</span>
                </div>
                <div class="col-lg-4 col-sm-4 ml-2 justify-content-right">
                    <div class="float-right">
                        <a href="javascript:void(0)" data-toggle="modal" data-target="#ajouter-modal"
                            class="btn ajouter-btn px-4 mr-2 float-left btn-lightblue" style="">Ajouter</a>
                        <span class="light-search-div">
                            <input type="image" class="light-search-icon" src="assets/img/media/search-icon.png" />
                            <input type="text" class="light-search-input" name="search_input" id="search_input"
    ...
    <div class="row mt-2" id="module_section">
        @include('administration.userList')
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="row">
                                        ...
                                        <div class="right-slim-div">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12">
                                                    <label>Email</label>
                                                    <input type="text" class="form-control"
                                                        value="xxxxxxxxxxxx@xxxxxxxxx.xx" />
                                                </div>
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8  tour-modal-fields-row-div"
                                    style="flex: 0 0 69.66666%; max-width: 69.66666%;">
                                    <div class="row">
                                        <div class="col-lg-9 col-md-9" style="flex: 0 0 57%; max-width: 61%;">
                                            <div class="white-card-div white-card-div-height">
                                                ...
                                                <span class="consigne-close"><img
                                                        src="assets/img/icons/white-blue-close.png" /></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-1 col-md-1" style="flex: 0 0 14%; max-width: 14%;">
                                            ...
                                            <div class="w-full white-card-div box-div-height text-center bg-green text-white"
                                                style="padding-top: 34%;">
                                                <a href="javascript:void(0)" class="text-white mt-4 text-bold"
                                                    data-toggle="modal" data-target="#intervention-modal">Planifier une
                                                    intervention</a>
                                            </div>
                                        ...
                                        <div class="col-lg-1 col-md-" style="flex: 0 0 14%; max-width: 14%;">
                                            ...
                                            <div class="w-full white-card-div box-div-height text-center bg-orange text-white"
                                                style="padding-top: 34%;">
                                                <a href="javascript:void(0)" class="text-white mt-4 text-bold"
                                                    data-toggle="modal" data-target="#visite-modal">Planifier une visite</a>
                                            </div>
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <nav>
                                                <div class="nav nav-tabs pose-navs" id="nav-client-details-tab"
                                                    role="tablist">
                                                    <a class="nav-item nav-link active" id="nav-historique-tab"
                                                        data-toggle="tab" href="#nav-historique" role="tab"
                                                        aria-controls="nav-historique" aria-selected="true">
                                                        <span class="tab-label">Historique</span>
                                                    </a>
                                                    <a class="nav-item nav-link" id="nav-deploiement-tab" data-toggle="tab"
                                                        href="#nav-deploiement" role="tab" aria-controls="nav-deploiement"
                                                        aria-selected="true">
                                                        <span class="tab-label">Déploiement</span>
                                                    </a>
                                                    <a class="nav-item nav-link" id="nav-technique-tab" data-toggle="tab"
                                                        href="#nav-technique" role="tab" aria-controls="nav-technique"
                                                        aria-selected="true">
                                                        <span class="tab-label">Technique</span>
                                                    </a>
                                                    <a class="nav-item nav-link" id="nav-notifications-tab"
                                                        data-toggle="tab" href="#nav-notifications" role="tab"
                                                        aria-controls="nav-notifications" aria-selected="true">
                                                        <span class="tab-label">Notifications <span
                                                                class="counter-span">2</span></span>
                                                    </a>
                                                    <a class="nav-item nav-link" id="nav-rc-tab" data-toggle="tab"
                                                        href="#nav-rc" role="tab" aria-controls="nav-rc"
                                                        aria-selected="true">
                                                        <span class="tab-label">RC <span
                                                                class="counter-span">2</span></span>
                                                    </a>
                                                    ...
                                                    <div class="switch-div">
                                                        ...
                                                        <strong
                                                            class="switch-green-label">Rendez-vouz<br />necessaire</strong>
                                                    </div>

                                                </div>
                                            </nav>
                                            <div class="tab-content" id="nav-tabContentClient">
                                                <div class="tab-pane fade show active" id="nav-historique" role="tabpanel"
                                                    aria-labelledby="nav-historique-tab">
                                                ...
                                                <div class="tab-pane fade" id="nav-deploiement" role="tabpanel"
                                                    aria-labelledby="nav-deploiement-tab">
                                                ...
                                                <div class="tab-pane fade" id="nav-technique" role="tabpanel"
                                                    aria-labelledby="nav-technique-tab">
                                                ...
                                                <div class="tab-pane fade" id="nav-notifications" role="tabpanel"
                                                    ...
                                                    <div class="row mt-4">
                                                        <div
                                                            class="col-lg-12 col-md-12 justify-content-center text-center">

                                                            <a href="javascript:void(0)" class="btn btn-lightblue px-4"
                                                                style="line-height: 2;" data-toggle="modal"
                                                                data-target="#notification-modal">Ajouter une
                                                                notification</a>
                                                ...
                                                <div class="tab-pane fade" id="nav-rc" role="tabpanel"
                                                    aria-labelledby="nav-rc-tab">
                                                    <div class="content-slim-div">
                                                    ...
                                                    <div class="row mt-4">
                                                        <div
                                                            ...
                                                            <a href="javascript:void(0)" class="btn btn-lightblue px-4"
                                                                style="line-height: 2;" data-toggle="modal"
                                                                data-target="#rc-modal">Ajouter une RC</a>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="justify-content-center text-center">
                                        ...
                                        <div class="weekdate-div" style="width: 15rem;">
                                            <div
                                                class="weekdate-div-nav weekdate-div-prev justify-content-center text-center">
                                            ...
                                            <div
                                                class="weekdate-div-nav weekdate-div-next justify-content-center text-center">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            ...
                                            <div class="text-dark-black">DU FAUBOURG POISSONNIERE<br />750009 PARIS 9E
                                                ARRONDISSEMENT</div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 35rem;">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form action="{{ route('administrationList.create') }}" method="post" data-parsley-validate>
                        @csrf
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <h2 class="w-full text-center mt-4 mb-4 ">Ajouter un administrateur</h2>



                                    {{-- <img src="assets/img/icons/agence-ajoute.png" /> --}}
                                    <div class="form-group">
                                        <label>Nom <span class="red_color">*</span></label>
                                        <input type="text" name="nom" class="form-control" placeholder="Nom"
                                            required data-parsley-required-message="Veuillez saisir l'identifiant nom">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="confirmer_mot_de_passe"
                                            class="form-control"
                                             required
                                            data-parsley-required-message="veuillez saisir le mot de passe de confirmation" data-parsley-pattern="^(?=.{8,}$)(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*\W).*$" data-parsley-equalto="#password1"
                                            data-parsley-pattern-message="La longueur minimale du mot de passe est de 8 caractères et doit contenir au moins 1 lettre minuscule, 1 lettre majuscule, 1 chiffre et 1 caractère spécial.">
                                    </div>

                                    <div class="form-group">
                                        <label>Attribuer un rôle <span class="red_color">*</span></label>
                                        <select class="form-control" name="role" required data-parsley-required-message="Sélectionnez un rôle valide">
                                    ...
                                    <div class="form-group">
                                        ...
                                        data-parsley-type="number" placeholder="Téléphone" >
                                    </div>
