...
@section('data-content')
    ...
    echo 'tour-switch-active';
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 tour-switch <?php if ($type == 'intervention') {
    echo 'tour-switch-active';
} ?>">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-sm-6" style="max-width: 5rem">
                        <span class="tour-gray-text"
                            onclick="setCollaborateurCalendarStatus('Rafraichir')">Rafraichir</span>
                    </div>
        ...
        <div class="" style="width:75%; float: left;">
            ...
            <div class="in-between">
                ...
                if (!empty($collabRecords)) {
                    ...
                    foreach ($collabRecords as $collabRecord) {
                        ...
                        echo '<div class="" style="height:20vh;padding-top: 1vh;' .
                            $marginTop .
                            '
                                            margin-bottom: 1vh;">
                                                        <div class="tour-num-top-div tour-num-top1" style="margin-bottom: 8vh;">
                                                            <span class="tour-num-top text-blue">' .
                            $collabRecord['statusPastFuture'] .
                            '</span>
                                                        </div>
                                                        <div class="tour-num-top-div tour-num-top1-green1">
                                                            <span class="tour-num-top tour-num-top-green text-white">' .
                            $collabRecord['statusRealised'] .
                            '</span>
                                                        </div>
                                                        <div class="tour-num-top-div tour-num-top1-orange1">
                                                            <span class="tour-num-top tour-num-top-orange text-white">' .
                            $collabRecord['statusKOCLient'] .
                            '</span>
                                                        </div>

                                                        <div class="tour-num-top-div tour-num-top1-red1">
                                                        <span class="tour-num-top tour-num-top-red text-white">' .
                            $collabRecord['statusKONotRealise'] .
                            '</span>
                                                    </div>
                ...
                <div class="" style="height:20vh">
                    ...
                    <div class="tour-num-top-div tour-num-top3 d-flex" style="position: absolute;bottom: 0;">
                        <span class="tour-num-top text-blue"
                            style="position: absolute;bottom: 15px;"><?php echo $totalStatusPastFuture; ?></span>
                    </div>
                ...
                <div class="rounded-corner bg-white col-white1">
                    ...
                    if (!empty($records)) {
                        ...
                        foreach ($records as $collabRecord) {
                            ...
                            echo '<div class="tour-row mt-3 ' .
                                $disabled .
                                '">
                                                        <input type="checkbox" name="" class="tour-checkbox-userinput" value="' .
                                $collab['id'] .
                                '" data-name="' .
                                $collab['prenom'] .
                                ' ' .
                                ...
                                '%</strong>
                                                        <div class="circle-chart-div">
                                                            <div class="circle-chart-inner-div">
                                                                ...
                                                                <circle class="circle-chart__circle" stroke="#FFF" stroke-width="2" stroke-dasharray="' .
                                $percentageCountMinus .
                                ...
                                '" class="tour-image" />
                                                        ...
                                                        <strong class="tour-row-text text-gray">' .
                                $collab['prenom'] .
                                ' ' .
                                $collab['nom'] .
                                '</strong>
                                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#technicien-modal"><strong class="tour-row-text text-blue">
                                                            <img src="' .
                                asset('assets/img/media/smallhouse.png') .
                                '" class="small-house"> ' .
                                $collab['adresse'] .
                                '
                                                        </strong></a>
            ...
            <div class="col-white7-col">
                <div class="rounded-corner bg-white col-white7 mt-3" style="width: 100%;">
                    ...
                    <div class="slimscroll-hours"
                        style="border-bottom: 1px solid #ececec;height: 38px;padding-top: 0 !important;">
                        ...
                        <?php
                        if ($time >= 10 && $time < 12) {
                            echo '<span class="tour-green text-left" style="position: absolute; z-index: 999; left: 16.5vw; font-size: 0.75rem;font-weight: bold;top: 1.5rem;color: #27c291;">' . $timeVal . '</span>';
                        }
                        ?>
                        ...
                        <?php
                        if ($time >= 12 && $time < 14) {
                            echo '<span class="tour-green text-left" style="position: absolute; z-index: 999; left: 21.5vw; font-size: 0.75rem;font-weight: bold;top: 1.5rem;color: #27c291;">' . $timeVal . '</span>';
                        }
                        ?>
                        ...
                        <?php
                        if ($time >= 14 && $time < 16) {
                            echo '<span class="tour-green text-left" style="position: absolute; z-index: 999; left: 27.5vw; font-size: 0.75rem;font-weight: bold;top: 1.5rem;color: #27c291;">' . $timeVal . '</span>';
                        }
                        ?>
                        <span class="tour-gray-text-hour tour-gray-text-hour6 text-left">16:00</span>
                        <?php
                        if ($time >= 16 && $time < 18) {
                            echo '<span class="tour-green text-right" style="position: absolute; z-index: 999; left: 33.5vw; font-size: 0.75rem;font-weight: bold;top: 1.5rem;color: #27c291;">' . $timeVal . '</span>';
                        }
                        ?>
                        <span class="tour-gray-text-hour tour-gray-text-hour7 text-left">18:00</span>
                        <?php
                        if ($time >= 18 && $time < 20) {
                            echo '<span class="tour-green text-right" style="position: absolute; z-index: 999; left: 39.5vw; font-size: 0.75rem;font-weight: bold;top: 1.5rem;color: #27c291;">' . $timeVal . '</span>';
                        }
                        ?>
                    ...
                    <div class="tour-right-row-div">
                        @if (!empty($collabRecords))
                            @if (count($collabRecords) > 1)
                                <img src="{{ asset('assets/img/media/tournees-icon.png') }}"
                                    style="position: absolute;top: 7.3rem;left: 2.5vw;z-index: 9;">
                            @endif
                        ...
                        <?php
                            if ($time >= 8 && $time < 10) {
                                echo '<div class="green-vl" style="border-left: 2px solid green;height: 76vh;width: 2px;position: absolute;left: 11.2vw;z-index: 999;"></div>';
                            }
                        ?>
                        <?php
                            if ($time >= 10 && $time < 12) {
                                echo '<div class="green-vl" style="border-left: 2px solid green;height: 76vh;width: 2px;position: absolute;left: 17.2vw;z-index: 999;"></div>';
                            }
                        ?>
                        <?php

                            if ($time >= 12 && $time < 14) {
                                echo '<div class="green-vl" style="border-left: 2px solid green;height: 76vh;width: 2px;position: absolute;left: 22.2vw;z-index: 999;"></div>';
                            }
                        ?>
                        <?php
                            if ($time >= 14 && $time < 16) {
                                echo '<div class="green-vl" style="border-left: 2px solid green;height: 76vh;width: 2px;position: absolute;left: 28.2vw;z-index: 999;"></div>';
                            }
                        ?>
                        <?php
                        ...
                        if ($time >= 18 && $time < 20) {
                            echo '<div class="green-vl" style="border-left: 2px solid green;height: 76vh;width: 2px;position: absolute;left: 40.2vw;z-index: 999;"></div>';
                        }
                        ?>
                                ...
                                if (!empty($collabRecords)) {
                                    ...
                                    foreach ($collabRecords as $collab) {
                                        ...
                                        foreach ($collabDataArr as $k => $collabData) {
                                            ...
                                            if ($collabData['assignee_id'] != $collab_id) {
                                                continue;
                                            }
                                            if ($collabData['client_id'] != $collab['client_id']) {
                                                continue;
                                            }
                                            ...
                                            if ($schedule <= $currentTime)
                                            {
                                                echo '<div class="tour-box">
                                                    ...
                                                    $tourCol .
                                                    '">
                                                        <strong class="tour-left-row-text text-black"> ' .
                                                    strtoupper($collabData['nom']) .
                                                    '</strong>
                                                    <strong class="tour-left-row-text text-blue"> ' .
                                                    strtoupper($collabData['adress']) .
                                                    '</strong>
                                                    ...
                                                    strtoupper($collabData['nom']) .
                                                    '</h6>
                                                        <p class="tx-10 mb-1" style="color: #7F7F7F">PDL ' .
                                                    strtoupper($collabData['pdl']) .
                                                    '</p>
                                                        <p style="color:  #7F7F7F">TYPE ' .
                                                    strtoupper($type) .
                                                    '</p>
                                                        <p class="tx-12 mb-1 text-blue font-weight-bold d-inline-block float-left p-2">' .
                                                    strtoupper($collabData['adress']) .
                                                    '</p>
                                                ...
                                                echo '<div class="tour-box">
                                                                                <div class="tour-box-gray tour-box-full  ' .
                                                    $tourCol .
                                                    '">
                                                                                    <strong class="tour-left-row-text text-black"> ' .
                                                    strtoupper($collabData['nom']) .
                    ...
                    <div class="text-right float-right" style="position:absolute;bottom:20px;right:20px;margin-right:20px">
                        <span class="bottom-small-text green-text">Succés </span><span
                            class="bottom-circle bottom-green-circle-count">{{ $success }}</span>
                        <span class="bottom-small-text orange-text">Semi KO </span><span
                            class="bottom-circle bottom-orange-circle-count">{{ $semiKO }}</span>
                        <span class="bottom-small-text red-text">KO </span><span
                            class="bottom-circle bottom-green-red-count">{{ $KO }}</span>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 bg-lightgray py-2 px-2 tour-employee-modal-right">
                            <div class="tour-employee-modal-arrow">
                                <a href="javascript:void(0)"><img src="assets/img/icons/gray-left-arrow.png"
                                        class="tour-employee-left-arrow" data-dismiss="modal"></a>
                            </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 text-right">
                                    ...
                                    <span class="tour-modal-button">
                                        <a href="javascript:void(0)"
                                            class="btn bg-white px-3 text-blue text-bold btn-shadow"
                                            style="line-height: 2;border-radius:  7rem !important">Editer la fiche</a>
                                    </span>
                                </div>
                            </div>
                                ...
                                <div class="tour-modal-tabs">
                                    <nav>
                                        <div class="nav nav-tabs tour-navs" id="nav-tour-modal-tab" role="tablist">
                                            <a class="nav-item nav-link active" id="nav-perimetre-tab" data-toggle="tab"
                                                href="#nav-perimetre" role="tab" aria-controls="nav-tour"
                                                aria-selected="true">
                                                <span class="tab-label">Pèrimètre de travail</span>
                                            </a>
                                            <a class="nav-item nav-link" id="nav-absences-tab" data-toggle="tab"
                                                href="#nav-absences" role="tab" aria-controls="nav-absences"
                                                aria-selected="true">
                                                <span class="tab-label">Liste des absences</span>
                                            </a>

                                            <a class="nav-item nav-link" id="nav-notifications-tab" data-toggle="tab"
                                    ...
                                    <div class="tab-content tour-right-content bg-white" id="nav-tabContent">
                                        ...
                                        <div class="tab-pane fade show active" id="nav-perimetre" role="tabpanel"
                                            aria-labelledby="nav-perimetre-tab">
                                            @include(
                                                'admin_planning.employee-tour.perimetre'
                                            )

                                        </div>

                                        <div class="tab-pane fade" id="nav-absences" role="tabpanel"
                                            aria-labelledby="nav-absences-tab">
                                            @include(
                                                'admin_planning.employee-tour.absences'
                                            )
                                        ...
                                        <div class="tab-pane fade" id="nav-notifications" role="tabpanel"
                                            ...
                                            @include(
                                                'admin_planning.employee-tour.notifications'
                                            )
