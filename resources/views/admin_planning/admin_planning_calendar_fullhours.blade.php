    ...
    <div class="" style="width:75%; float: left;">
        ...
        <div class="in-between">
                        ...
                        echo '<div class="" style="height:20vh;padding-top: 1vh;'.$marginTop.'
                            margin-bottom: 1vh;">
                                        ...
                                        <div class="tour-num-top-div tour-num-top1-green1">
                                            <span class="tour-num-top tour-num-top-green text-white">'.$collabRecord['statusKONotRealise'].'</span>
                                        </div>
                                        ...
                                        <span class="tour-num-top tour-num-top-red text-white">'.$collabRecord['statusRealised'].'</span>
                                    </div>
            ...
            <div class="tour-num-top-div tour-num-top3 d-flex" style="position: absolute;bottom: 0;">
                <span class="tour-num-top text-blue" style="position: absolute;bottom: 15px;">300</span>
            </div>
        ...
        <div class="col-white7-col">
            <div class="rounded-corner bg-white col-white7 mt-3" style="overflow-x: scroll;width: 100%;">
                
                <div class="slimscroll-hours" style="border-bottom: 1px solid #ececec;height: 38px;padding-top: 0 !important;">


                        <span class="tour-gray-text-hour tour-gray-text-hour1 text-left">00:00</span>

                        <?php
                            if($time > 0 && $time < 2){
                                echo '<span class="tour-green text-left" style="position: absolute; z-index: 999; left: 8; font-size: 0.75rem;font-weight: bold;top: 1.5rem;color: #27c291;">'.$timeVal.'</span>';
                            }
                        ?>

                        <span class="tour-gray-text-hour tour-gray-text-hour2 text-left">02:00</span>

                        <?php
                            if($time > 2 && $time < 4){
                                echo '<span class="tour-green text-left" style="position: absolute; z-index: 999; left: 16vw; font-size: 0.75rem;font-weight: bold;top: 1.5rem;color: #27c291;">'.$timeVal.'</span>';
                            }
                        ?>

                        <span class="tour-gray-text-hour tour-gray-text-hour3 text-left">04:00</span>

                        <?php
                            if($time > 4 && $time < 6){
                                echo '<span class="tour-green text-left" style="position: absolute; z-index: 999; left: 24vw; font-size: 0.75rem;font-weight: bold;top: 1.5rem;color: #27c291;">'.$timeVal.'</span>';
                            }
                        ?>

                        <span class="tour-gray-text-hour tour-gray-text-hour4 text-left">6:00</span>
                        <?php
                            if($time > 6 && $time < 8){
                                echo '<span class="tour-green text-left" style="position: absolute; z-index: 999; left: 32vw; font-size: 0.75rem;font-weight: bold;top: 1.5rem;color: #27c291;">'.$timeVal.'</span>';
                            }
                        ?>

                        <span class="tour-gray-text-hour tour-gray-text-hour5 text-left">8:00</span>
                        <?php

                            if($time > 8 && $time < 10){
                                
                                echo '<span class="tour-green text-left" style="position: absolute; z-index: 999; left: 40vw; font-size: 0.75rem;font-weight: bold;top: 1.5rem;color: #27c291;">'.$timeVal.'</span>';
                            }
                        ?>
                        <span class="tour-gray-text-hour tour-gray-text-hour6 text-left">10:00</span>
                        <?php
                            if($time > 10 && $time < 12){
                                echo '<span class="tour-green text-right" style="position: absolute; z-index: 999; left: 48vw; font-size: 0.75rem;font-weight: bold;top: 1.5rem;color: #27c291;">'.$timeVal.'</span>';
                            }
                        ?>
                        <span class="tour-gray-text-hour tour-gray-text-hour7 text-left">12:00</span>
                        <?php
                            if($time > 12 && $time < 14){
                                echo '<span class="tour-green text-right" style="position: absolute; z-index: 999; left: 56vw; font-size: 0.75rem;font-weight: bold;top: 1.5rem;color: #27c291;">'.$timeVal.'</span>';
                            }
                        ?>
                        <span class="tour-gray-text-hour tour-gray-text-hour8 text-left">14:00</span>
                        <?php
                            if($time > 14 && $time < 16){
                                echo '<span class="tour-green text-right" style="position: absolute; z-index: 999; left: 64vw; font-size: 0.75rem;font-weight: bold;top: 1.5rem;color: #27c291;">'.$timeVal.'</span>';
                            }
                        ?>
                        <span class="tour-gray-text-hour tour-gray-text-hour9 text-left">16:00</span>
                        <?php
                            if($time > 16 && $time < 18){
                                echo '<span class="tour-green text-right" style="position: absolute; z-index: 999; left: 72vw; font-size: 0.75rem;font-weight: bold;top: 1.5rem;color: #27c291;">'.$timeVal.'</span>';
                            }
                        ?>
                        
                        <span class="tour-gray-text-hour tour-gray-text-hour10 text-left">18:00</span>
                        <?php
                            if($time > 18 && $time < 20){
                                echo '<span class="tour-green text-right" style="position: absolute; z-index: 999; left: 80vw; font-size: 0.75rem;font-weight: bold;top: 1.5rem;color: #27c291;">'.$timeVal.'</span>';
                            }
                        ?>
                        <span class="tour-gray-text-hour tour-gray-text-hour11 text-left">20:00</span>
                    </div>
                    ...
                    <div class="tour-right-row-div">
                        @if(!empty($collabRecords))
                            @if(count($collabRecords) > 1)
                                <img src="{{ asset('assets/img/media/tournees-icon.png') }}" style="position: absolute;top: 9.8rem;left: 2.5vw;z-index: 9;">
                            @endif
                        ...
                        <?php
                            if($time > 0 && $time < 2){
                                echo '<div class="green-vl" style="border-left: 2px solid green;height: 76vh;width: 2px;position: absolute;left: 8vw;z-index: 1;"></div>';
                            }
                        ?>

                        <?php
                            if($time > 2 && $time < 4){
                                echo '<div class="green-vl" style="border-left: 2px solid green;height: 76vh;width: 2px;position: absolute;left: 16vw;z-index: 1;"></div>';
                            }
                        ?>

                        <?php
                            if($time > 4 && $time < 6){
                                echo '<div class="green-vl" style="border-left: 2px solid green;height: 76vh;width: 2px;position: absolute;left: 24vw;z-index: 1;"></div>';
                            }
                        ?>

                        <?php
                            if($time > 6 && $time < 8){
                                echo '<div class="green-vl" style="border-left: 2px solid green;height: 76vh;width: 2px;position: absolute;left: 32vw;z-index: 1;"></div>';
                            }
                        ?>
                        <?php
                            if($time > 8 && $time < 10){
                                echo '<div class="green-vl" style="border-left: 2px solid green;height: 76vh;width: 2px;position: absolute;left: 40vw;z-index: 1;"></div>';
                            }
                        ?>
                        <?php
                        echo '<div class="green-vl" style="border-left: 2px solid green;height: 76vh;width: 2px;position: absolute;left: 48vw;z-index: 1;"></div>';
                            if($time > 10 && $time < 12){
                                
                                echo '<div class="green-vl" style="border-left: 2px solid green;height: 76vh;width: 2px;position: absolute;left: 56vw;z-index: 1;"></div>';
                            }
                        ?>
                        <?php
                            if($time > 12 && $time < 14){
                                echo '<div class="green-vl" style="border-left: 2px solid green;height: 76vh;width: 2px;position: absolute;left: 64vw;z-index: 1;"></div>';
                            }
                        ?>
                         <?php
                            if($time > 14 && $time < 16){
                                echo '<div class="green-vl" style="border-left: 2px solid green;height: 76vh;width: 2px;position: absolute;left: 72vw;z-index: 1;"></div>';
                            }
                        ?>
                        <?php
                            if($time > 16 && $time < 18){
                                echo '<div class="green-vl" style="border-left: 2px solid green;height: 76vh;width: 2px;position: absolute;left: 80vw;z-index: 1;"></div>';
                            }
                        ?>
                        <?php
                            if($time > 18 && $time < 20){
                                echo '<div class="green-vl" style="border-left: 2px solid green;height: 76vh;width: 2px;position: absolute;left: 88vw;z-index: 1;"></div>';
                            }
                        ?>
                        ...
                        <?php
                            ...
                            if(!empty($collabRecords)){
                                foreach($collabRecords as $collab){
                                    ...
                                    // print_r($collabDataArr);
                                    // exit;

                                    $disabledRow = '';
                                    if($collab['status'] == 'inactive'){

                                        $disabledRow = 'tour-disabled-bg-row';
                                    }

                                    
                                    echo '<div class="tour-right-row blue-border">';
                                    ...
                                    foreach($collabDataArr as $k => $collabData){
                                        ...
                                        $tourCol = 'tour-col-1';
                                        if($hour == '2' || $hour == '02' || $hour == '4' || $hour == '04' || $hour == '20'){
                                            continue;
                                        }
                                        ...
                                        if($schedule <= $currentTime){
                                            ...
                                            echo '<div class="tour-box">
                                                <div class="tour-box-gray tour-box-full tour-col-1">
                                                    <strong class="tour-left-row-text text-black"> '.strtoupper($collabData['nom']).'</strong>
                                                    <strong class="tour-left-row-text text-blue"> '.strtoupper($collabData['adress']).'</strong>
                                                    <div class="tour-circle-icons-div">
                                                        <span class="tour-left-white-circle">G3</span>
                                    ...
                                    foreach($collabDataArr as $k => $collabData){
                                        ...
                                        $color = 'blue';
                                        if($type == 'intervention'){
                                            if($collabData['intervention_status'] != 1 && $collabData['intervention_status'] != 2 && $collabData['intervention_status'] != 3)
                                            {
                                                continue;
                                            }

                                            if($collabData['intervention_status'] == 1)
                                                $color = 'red';
                                            ...
                                            if($collabData['visite_status'] != 1 && $collabData['visite_status'] != 2 && $collabData['visite_status'] != 3)
                                            {
                                                continue;
                                            }

                                            if($collabData['visite_status'] == 1)
                                                $color = 'red';
                                        ...
                                        if($schedule <= $currentTime){
                                            echo '<div class="tour-box">
                                                <div class="tour-box-'.$color.' tour-box-full tour-col-1">
                                                    <strong class="tour-left-row-text text-black"> '.strtoupper($collabData['nom']).'</strong>
                                                    <strong class="tour-left-row-text text-blue"> '.strtoupper($collabData['adress']).'</strong>
                                                    <div class="tour-circle-icons-div">
                                                        <span class="tour-left-white-circle">G3</span>
