...
@section('data-content')
    <div class="row row-sm mt-4">
        <div class="col-lg-2 col-sm-2">
            <strong class="tx-16 black-text font-weight-bold user-fullname">RECHERCHE DE TECHNICIEN</strong>
        </div>
        <div class="col-lg-4 col-sm-4">
            <strong class="text-blue tx-11"></strong>
        </div>
            ...
            <div class="row mr-1">
                ...
                <div class="col-lg-4" style="margin-top:-3px">
                    <a class="btn-blue-white float-right px-4" href="javascript:void(0)" data-toggle="modal"
                        data-target="#EmployeeImport">
                        Importer
                    </a>

                </div>
                <div class="col-lg-5" style="margin-top:-3px">
                    <a href="EmployeeExport" class="btn-white-blue float-right px-4">
                        Exporter
                    </a>
                </div>
            </div>
                    ...
                    <table class="table table-striped w-100" id="clientDataTable">
                        ...
                        <tbody>
                            @foreach ($data as $client)
                                <tr>
                                    <td id="ClickNomeID">{{ $client->nom }}</td>
                                    <td>{{ $client->prenom }}</td>
                                    <td>{{ $client->type }}</td>
                                    <td>{{ $client->poste }}</td>
    ...
    <div class="modal fade" id="EmployeeImport" tabindex="-1" role="dialog" aria-labelledby="technicien-modal"
        aria-hidden="true">
