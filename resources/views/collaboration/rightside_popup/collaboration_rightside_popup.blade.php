                           ...
                           <div class="tour-modal-tabs">
                               <nav>
                                   <div class="nav nav-tabs tour-navs" id="nav-tour-modal-tab" role="tablist">
                                       <a class="nav-item nav-link active" id="nav-perimetre-tab" data-toggle="tab" href="#nav-perimetre_{{$collaboration->id}}" role="tab" aria-controls="nav-tour" aria-selected="true">
                                           <span class="tab-label">Pèrimètre de travail</span>
                                       </a>
                                       <a class="nav-item nav-link" id="nav-absences-tab" data-toggle="tab" href="#nav-absences_{{$collaboration->id}}" role="tab" aria-controls="nav-absences" aria-selected="true">
                                           <span class="tab-label">Liste des absences</span>
                                       </a>

                                       <a class="nav-item nav-link" id="nav-notifications-tab" data-toggle="tab" href="#nav-notifications_{{$collaboration->id}}" role="tab" aria-controls="nav-notifications" aria-selected="true">
                               ...
                               <div class="tab-content tour-right-content bg-white" id="nav-tabContent">
                                   ...
                                   <div class="tab-pane fade show active" id="nav-perimetre_{{$collaboration->id}}" role="tabpanel" aria-labelledby="nav-perimetre-tab">
                                       @include('collaboration.rightside_popup.perimetre')

                                   </div>

                                   {{-- absences start --}}
                                   <div class="tab-pane fade" id="nav-absences_{{$collaboration->id}}" role="tabpanel" aria-labelledby="nav-absences-tab">
                                           ...
                                           <div class="row mt-4 mb-4">
                                               <div class="col text-center">
                                                   <a href="{{url('/collaboration/' . $collaboration->id . '/absences_ecarts')}}" class="btn-green" ><strong class="tour-row-text text-white">Ajouter une absence</strong></a>
                                               </div>
                                           </div>
                                   ...
                                   <div class="tab-pane fade" id="nav-notifications_{{$collaboration->id}}" role="tabpanel" aria-labelledby="nav-notifications-tab">
