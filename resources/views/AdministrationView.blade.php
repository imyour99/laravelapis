    ...
    <div class="col-lg-12 col-sm-12 mb-2">
        <div class="row">
            ...
            <div class="col-lg-7 col-sm-7 ml-2">
                <h2>Jane Doe</h2>
                <span class="text-blue mr-2">Super Admin</span><span class="text-dark-black ml-3">janedoe@gmail.com</span>
            </div>
            <div class="col-lg-4 col-sm-4 ml-2 justify-content-right">
                <div class="float-right">
                    <a href="javascript:void(0)" data-toggle="modal" data-target="#ajouter-modal" class="btn ajouter-btn px-4 mr-2 float-left btn-lightblue" style="" >Ajouter</a>
        ...
        <div class="rounded-corner bg-white px-2">
            <div class="table-responsive">
                <table class="table table-striped w-100 administrators-table" id="clientDataTable" style="width:100%">
                    <thead>
                        <tr>
                            <th class="wd-15p text-center">ID Utilisateur</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td id="ClickNomeID" >{{ $technician->nom}}</td>
...
<!--                        <tr>
    <td class="admin-user-td">
        ...
        <strong class="text-block float-left ml-4 py-3">ALEXANDRADMIN</strong>
    </td>
    <td>ALEXANDER JOE</td>
