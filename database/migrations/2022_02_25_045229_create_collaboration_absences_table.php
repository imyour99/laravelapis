...
class CreateCollaborationAbsencesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('collaboration_absences', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('collaboration_absences');
    }
}
