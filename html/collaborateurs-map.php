...
<div class="row row-sm mt-4">
    ...
    <div class="col-lg-4 col-sm-4 mb-2" style="margin-top:-8px">
        <div class="float-right">
            <div class="circle-icon circle-icon1 mt-1">
                    <a href="collaborateurs.php">
                                    ...
                                    <div class="col-lg-12 col-sm-12 pl-1 pr-2">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-1 col-sm-1 p-2">
                                                ...
                                                <img src="assets/img/icons/blue-calendar-white.png" style="margin-top: -3px;">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBHqmol9ZCmFqyUVzbcbgOtCrvx78gl12g&callback=initMap&v=weekly&channel=2" async>
</script>
